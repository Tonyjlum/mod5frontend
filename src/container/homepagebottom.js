...
const HomepageBottomContainer = () => {
  return (
    <CardGroup>
      ...
      <Card className="home-card">
        <Card.Img variant="top" src="https://image.flaticon.com/icons/svg/1006/1006652.svg" heigh="50px"/>
        <Card.Body>
        <Card.Text>
    ...
    <Card className="home-card">
      <Card.Img variant="top" src="https://image.flaticon.com/icons/svg/1006/1006623.svg" heigh="50px"/>
      <Card.Body>
      <Card.Text>
    ...
    <Card className="home-card">
      <Card.Img variant="top" src="https://image.flaticon.com/icons/svg/1534/1534938.svg" heigh="50px"/>
      <Card.Body>
      <Card.Text>
